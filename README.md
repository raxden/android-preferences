...
dependencies {
	    compile 'com.github.raxden:AndroidPreferences:4.0.3@aar'
...
For a **detailed documentation**, please have a look at the [**Wiki**](https://github.com/raxden/AndroidPreferences/wiki) or the [**Javadocs**](https://jitpack.io/com/github/raxden/AndroidPreferences/4.0.3/javadoc/).
